...
def copy_coadd_meta(model, cat_model):
    # TODO some junk values here
    cat_model.meta.prd_version = "8.8.8"
    cat_model.meta.sdf_software_version = "7.7.7"
    cat_model.meta.coadd_info.time_first_mjd = model.meta.coadd_info.time_first.mjd
    cat_model.meta.coadd_info.time_last_mjd = model.meta.coadd_info.time_last.mjd
    cat_model.meta.coadd_info.time_mean_mjd = model.meta.coadd_info.time_mean.mjd
    cat_model.meta.coadd_info.max_exposure_time = model.meta.coadd_info.get(
        "max_exposure_time", np.nan
    )
    cat_model.meta.coadd_info.mean_exposure_time = model.meta.coadd_info.exposure_time
    cat_model.meta.coadd_info.visit = model.meta.observation.visit
    cat_model.meta.coadd_info.segment = model.meta.observation.segment
    cat_model.meta.coadd_info["pass"] = model.meta.observation["pass"]
    cat_model.meta.coadd_info.program = model.meta.observation.program
    cat_model.meta.coadd_info.survey = "?"

    # TODO handle optical element with multiple values
    cat_model.meta.coadd_info.optical_element = model.meta.instrument.optical_element

    cat_model.meta.coadd_info.instrument = "WFI"
    cat_model.meta.coadd_info.location_name = model.meta.wcsinfo.skycell_name
    cat_model.meta.coadd_info.product_type = model.meta.product_type
    return cat_model
